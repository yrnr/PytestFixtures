...
from .page_scenario_1 import Page_Scenario_1 as ps1
from .page_scenario_1 import Page_Scenario_2 as ps2
from .page_scenario_1 import Page_Scenario_3 as ps3
